...
# XNA Does not support segwit, though this logic does not change from BTC
'''
...
@has_automation("automations/accept.json")
def test_sign_neurai_create(cmd):
    sign_from_json(cmd, 'data/neurai/create/tx.json')

@has_automation("automations/accept.json")
def test_sign_neurai_reissue(cmd):
    sign_from_json(cmd, 'data/neurai/reissue/tx.json')

@has_automation("automations/accept.json")
def test_sign_neurai_tag_qual(cmd):
    sign_from_json(cmd, 'data/neurai/qualify_address/tx.json')

@has_automation("automations/accept.json")
def test_sign_neurai_restricted(cmd):
    sign_from_json(cmd, 'data/neurai/reissue_restricted/tx.json')

@has_automation("automations/accept.json")
def test_sign_neurai_global_freeze(cmd):
    sign_from_json(cmd, 'data/neurai/global_freeze/tx.json')
